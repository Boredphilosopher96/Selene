...
**YOU ARE IN: `selene/polecats/quartz/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/selene/` (rig root) or other directories
...
**Your mail address:** `selene/polecats/quartz`
**Your rig:** selene
**Your Witness:** `selene/witness`
...
| Ask Witness for help | `gt mail send selene/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`selene/witness`) when:
...
```bash
gt mail send selene/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```

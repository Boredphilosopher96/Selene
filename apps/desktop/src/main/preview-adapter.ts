...
const identifier=/^[A-Za-z0-9][A-Za-z0-9._:-]{0,127}$/;let port;let closed=false;let canvasNavigationEnabled=false;let canvasPointerSelection=false;let pendingCanvasSelection;let suppressUnsupportedClick=false;let targetCancelEnabled=false;let selectionInteractionSequence=0;

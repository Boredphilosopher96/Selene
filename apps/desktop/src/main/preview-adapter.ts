...
const unmappedElementTelemetry=node=>{const {hierarchy,alignmentTargets,explicitAriaRole,ariaLabel,accessibleDescription,ariaDisabled,ariaExpanded,ariaPressed,ariaChecked,ariaSelected,ariaHidden,tabIndex,...telemetry}=elementTelemetry(node);return telemetry};

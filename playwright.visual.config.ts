...
export default defineConfig({
  ...
  webServer: {
    command: `bun scripts/playwright-web-server.mjs visual-storybook ${ports.visualStorybook} bun x --bun storybook dev --config-dir packages/ui/.storybook --port ${ports.visualStorybook} --exact-port --ci`,

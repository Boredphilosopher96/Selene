...
const fixture: DesignerSnapshot = {
  ...
  reviewThreads: [{ id: 'thread-total', status: 'open', body: 'Verify total remains visible.', author: 'Reviewer', createdAt: '2026-07-24T19:00:00.000Z', anchor: { x: .72, y: .58, artifactId: 'cockpit-r1', screenId: 'orders', scenarioId: 'review', state: 'success', revisionId: 'cockpit-r1', viewport: { width: 1200, height: 800 } } }],
...
function FixtureCockpit({ recovery = false, runMode = false }: { readonly recovery?: boolean; readonly runMode?: boolean }) {
